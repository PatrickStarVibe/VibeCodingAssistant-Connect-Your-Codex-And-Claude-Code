@REM Purpose: Windows double-click launcher for the VibeCodingAssistant assistant startup flow.
@REM Author: VibeCodingAssistant distribution tooling
@echo off
setlocal
...
echo ===============================================
echo VibeCodingAssistant Launcher
echo ===============================================
