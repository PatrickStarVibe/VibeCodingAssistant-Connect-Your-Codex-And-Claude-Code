...
function renderTaskRecord(input: TaskRecordFinalizeInput): string {
  ...
  return [
    ...
    '## Implementation Process',
    '',
    'Plan, sequential execution, final review, and user acceptance were completed through VibeCodingAssistant.',
    '',
    '## Files Changed',
    '',
    ...
    '## Algorithm Logic',
    '',
    'No specific product algorithm was recorded by VibeCodingAssistant for this task unless noted in the implementation log.',
    '',
    '## Connected Systems',
    '',
