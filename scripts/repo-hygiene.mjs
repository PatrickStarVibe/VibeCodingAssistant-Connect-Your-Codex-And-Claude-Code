/*
 * Repo hygiene checker for VibeCodingAssistant distribution and publish readiness.
 * Runs git, ignore-file, lockfile, and package version checks without external dependencies.
 * Author: VibeCodingAssistant distribution tooling
 */
...
function formatHuman(payload) {
  if (payload.help) {
    return [
      "VibeCodingAssistant repo hygiene checker",
      "",
  ...
  const lines = ["VibeCodingAssistant repo hygiene check", ""];
