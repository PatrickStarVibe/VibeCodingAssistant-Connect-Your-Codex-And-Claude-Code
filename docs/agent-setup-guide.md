...
Use this guide when a coding agent is asked to configure VibeCodingAssistant for a user's local VibeCodingAssistant workflow.
...
1. Confirm the VibeCodingAssistant repo root and whether local config files already exist.
...
Run these from the VibeCodingAssistant repo root:
