...
If it is missing, VibeCodingAssistant uses:
...
Architect may suggest Category. VibeCodingAssistant stores it. Missing or unknown Category becomes `Other`.

## Lifecycle Timing

- On task creation, VibeCodingAssistant may initialize `task/<task-id>/` with README and standard placeholder files.
